    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" asChild>
          <Link href="/fornecedores"><ArrowLeft size={18} /></Link>
        </Button>
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Novo Fornecedor</h1>
          <p className="text-slate-500 text-sm">Cadastrar fornecedor de materiais</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2 col-span-2">
                ...
                <Input placeholder="Materiais Impermeabilização SA" {...register("nome")} />
              ...
              <div className="space-y-2 col-span-2">
                <Label>E-mail</Label>
                <Input type="email" placeholder="vendas@fornecedor.com" {...register("email")} />
        ...
        <div className="flex justify-end gap-3 mt-4">
          <Button variant="outline" asChild><Link href="/fornecedores">Cancelar</Link></Button>
